...
export let arrproducts:Productype[] = [
  { id: 1, category: "Shoe", name: "Running Shoes", price: 120, image:'https://img.freepik.com/free-photo/men-shoes_1203-8696.jpg?t=st=1743227020~exp=1743230620~hmac=15abfd4e28598ab1d8df3911dc521db13d5bfb88f5c364e81aed438cedfcd6f8&w=1380', quantity: 1, isFeatured: true, actions: Trash },
  { id: 2, category: "Shoe", name: "Casual Sneakers", price: 80, image:'https://img.freepik.com/free-photo/men-shoes_1203-8654.jpg?t=st=1743240195~exp=1743243795~hmac=7e5e61cfaeb38f8ea1475ad8322953df99fdf76a9c766041af22f2ca1fcf0a8e&w=1380', quantity: 1, isFeatured: false, actions: Trash },
  { id: 3, category: "T-Shirt", name: "Graphic T-Shirt", price: 25, image:'https://img.freepik.com/free-vector/yellow-t-shirt-camp-design_1392-23.jpg?t=st=1743244562~exp=1743248162~hmac=c9dec4367eca7812fea925a14d21af3421514ab8fe28c092d7d3548940eaf0c0&w=740', quantity: 1, isFeatured: true, actions: Trash },
  ...
  { id: 12, category: "Bag", name: "Tote Bag", price: 40, image:'https://img.freepik.com/free-photo/roadtrip-concept-with-backpack-flask_23-2149270128.jpg?t=st=1743241785~exp=1743245385~hmac=d2419d29d1825af773dd9f32a45f238fe28db5d96a31a47919176e0d3aeef20c&w=1380', quantity: 1, isFeatured: false, actions: Trash },
  { id: 13, category: "Jacket", name: "Leather Jacket", price: 200 , image:'/freepik__black-bomber-jacket-hanging-on-a-white-plastic-han__67988.png', quantity: 1, isFeatured: true, actions: Trash },
  { id: 14, category: "Jacket", name: "Denim Jacket", price: 100, image:'freepik__black-bomber-jacket-hanging-on-a-white-plastic-han__67989.png', quantity: 1, isFeatured: false, actions: Trash }
];
